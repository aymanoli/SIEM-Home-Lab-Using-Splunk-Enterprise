# SOC SIEM Home Lab Using Splunk Enterprise
...
* Monitored Windows Security and System logs to gain hands-on experience with SIEM operations.
* Built simple dashboards to visualize login activities and security events.
* Used Splunk Search Processing Language (SPL) to search, filter, and analyze log data.
* Developed foundational skills in log analysis, security monitoring, and incident investigation workflows.
